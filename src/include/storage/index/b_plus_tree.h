...
namespace bustub {
// 1. 定义操作类型
enum class Operation { SEARCH, INSERT, DELETE,READ };
...
class BPlusTree {
 ...
 public:
  ...
  // 释放事务中的锁
  void ReleaseLatchFromQueue(BufferPoolManager *bpm,Transaction *txn);
 ...
 private:
  ...
  auto FindLeafPage(const KeyType &key, bool left_most, Operation op, Transaction *transaction) -> Page *;
